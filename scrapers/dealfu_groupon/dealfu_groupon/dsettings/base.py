...
ITEM_PIPELINES = {
    ...
    "dealfu_groupon.pipelines.grouponespipe.GrouponEsPipeLine":500
}
...
#DATA SCIENCE ENDPOINT FREE SERVICE
DATASCIENCE_GEO_API_ENDPOINT = "http://www.datasciencetoolkit.org/maps/api/geocode/json"